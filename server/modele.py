...
class Player:
    ...
    def to_dict(self):
        return {
            ...
            "buzzer_isConnected": self.buzzer.isConnected if self.buzzer else False,
            "buzzer_isActivated": self.buzzer.isActivated if self.buzzer else False,
            "buzzer_isTalking": self.buzzer.isTalking if self.buzzer else False,
